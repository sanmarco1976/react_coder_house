const productos = [
    ...
    { id: '7', categoria: 'nigth', nombre: 'CONJUNTO UMA', precio: 2000, img: '../Img/conj_uma.jpeg', stock: 2  },
    { id: '8', categoria: 'day', nombre: 'PIJAMA ANASTASIA', precio: 2400, img: '../Img/pijama_anastasia2.jpg', stock: 3  },
    { id: '9', categoria: 'nigth', nombre: 'CONJUNTO LETY', precio: 1790, img: '../Img/prod_lety2.jpg', stock: 4  },
    { id: '10', categoria: 'nigth', nombre: 'TOP BRANCA', precio: 2000, img: '../Img/top_branca.jpg', stock: 6  },
    { id: '11', categoria: 'day', nombre: 'TOP FELICITAS', precio: 1580, img: '../Img/top_felicitas.jpg', stock: 5 }
]
